...
VL_INLINE_OPT void Vtop___024root___nba_sequent__TOP__0(Vtop___024root* vlSelf) {
    ...
    if (vlSelf->reset) {
        ...
        if ((((0x300U == vlSelf->top__DOT__imm) & (IData)(vlSelf->top__DOT____VdfgRegularize_h245778ca_0_45)) 
             | ((0x30200073U == vlSelf->ist) | (0x73U 
                                                == vlSelf->ist)))) {
            vlSelf->mstatus = vlSelf->top__DOT__mstatus_next;
        }
        if ((((0x342U == vlSelf->top__DOT__imm) & (IData)(vlSelf->top__DOT____VdfgRegularize_h245778ca_0_45)) 
             | (0x73U == vlSelf->ist))) {
            vlSelf->mcause = vlSelf->top__DOT__mcause_next;
        }
        if (((0x305U == vlSelf->top__DOT__imm) & (IData)(vlSelf->top__DOT____VdfgRegularize_h245778ca_0_45))) {
            vlSelf->mtvec = vlSelf->top__DOT__mtvec_next;
        }
        if ((((0x341U == vlSelf->top__DOT__imm) & (IData)(vlSelf->top__DOT____VdfgRegularize_h245778ca_0_45)) 
             | (0x73U == vlSelf->ist))) {
