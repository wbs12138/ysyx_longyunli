...
void Vtop___024root__trace_chg_0_sub_0(Vtop___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    if (VL_UNLIKELY((vlSelf->__Vm_traceActivity[1U] 
        ...
        bufp->chgIData(oldp+46,(vlSelf->top__DOT__pc_next),32);
        bufp->chgIData(oldp+47,(vlSelf->top__DOT__mem_waddr),32);
    }
    if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[2U])) {
        bufp->chgIData(oldp+48,(vlSelf->top__DOT__inst_RegisterFile__DOT__rf
                                [0xfU]),32);
        bufp->chgIData(oldp+49,(vlSelf->top__DOT__mepc),32);
        bufp->chgIData(oldp+50,(vlSelf->top__DOT__mtvec),32);
    ...
    bufp->chgBit(oldp+97,(((0x17U == (0x7fU & vlSelf->ist)) 
                           | (0x37U == (0x7fU & vlSelf->ist)))));
    bufp->chgCData(oldp+98,((0x1fU & (vlSelf->ist >> 0xfU))),5);
    bufp->chgCData(oldp+99,((0x1fU & (vlSelf->ist >> 0x14U))),5);
    bufp->chgCData(oldp+100,((0x1fU & (vlSelf->ist 
                                       >> 7U))),5);
    bufp->chgIData(oldp+101,(vlSelf->top__DOT__rdata_mem),32);
    bufp->chgIData(oldp+102,(vlSelf->top__DOT__rf_wdata),32);
    bufp->chgBit(oldp+103,(((0x37U == (0x7fU & vlSelf->ist)) 
    ...
    bufp->chgIData(oldp+104,(((IData)(vlSelf->top__DOT__csrrw)
                              ...
                              [0xfU] : ((IData)(vlSelf->top__DOT__csrrs)
                                         ? (vlSelf->top__DOT__mepc 
                                            ...
                                            [0xfU])
                                         : vlSelf->pc))),32);
    bufp->chgBit(oldp+105,((IData)((0x67U == (0x707fU 
                                              & vlSelf->ist)))));
    bufp->chgIData(oldp+106,(VL_SHIFTR_III(32,32,32, vlSelf->ist, 0x14U)),32);
    bufp->chgBit(oldp+107,((IData)((0xefU == (0xfffU 
                                              & vlSelf->ist)))));
    bufp->chgBit(oldp+108,((0x8067U == vlSelf->ist)));
    bufp->chgBit(oldp+109,((IData)((0xe7U == (0x7fffU 
                                              & vlSelf->ist)))));
    bufp->chgBit(oldp+110,((IData)((0x67U == (0xfff07fffU 
                                              & vlSelf->ist)))));
}
